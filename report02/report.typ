...
- `0x00000000` から `0x00000fff` まで → p: `0x000`, t: `0x000`
- `0x00001000` から `0x00001fff` まで → p: `0x000`, t: `0x001`
- `0xfffff000` から `0xffffffff` まで → p: `0x3ff`, t: `0x3ff`

ページテーブルの形と内容は @fig205 のようになる。

#figure(
  image("./fig205.png"),
  caption: [問題205: ページテーブルの形と内容]
) <fig205>

また、ページテーブルに必要なメモリは、$4096 + 8192 = 12288$ より、12,288 バイト (12KiB)
